  ...
  try {
    ...
    switch (action) {
      ...
      case 'warn':
        ...
        result = { success: true, message: `User warned successfully. Total warnings: ${currentWarnings + 1}` }
        break

      default:
        return NextResponse.json(
          { error: 'Invalid action. Allowed actions: delete, disable, ban, enable, warn' },
          { status: 400 }
        )
    }
