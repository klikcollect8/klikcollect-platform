...
import type { HomeHero, HomeVendorCard } from "@/lib/home-page-data";

/** Marketplace home — products/categories/hero/vendors from SSR. */
export default function ObscuraHome({
  products,
  categories = [],
  hero,
  vendors = [],
  ...
  return (
    <div className="w-full bg-[#f7f7f5] text-black">
      ...
      <div className="mx-auto w-full max-w-[1600px] space-y-16 px-4 py-12 sm:space-y-24 sm:px-10 sm:py-20 lg:space-y-32 lg:px-14 xl:px-20">
        ...
        <FoundingVendors vendors={vendors} />
