...
/** Full-width promo carousel - same composition as the bag page */
export default function PromoCarousel({ slides }: { slides: PromoSlide[] }) {
  ...
  useEffect(() => {
    ...
    const nodes = root.querySelectorAll<HTMLElement>(".kc-promo-slide");
    ...
    >
      <div className="relative mx-auto w-full max-w-[1600px] lg:min-h-[40svh]">
        <div className="relative flex min-h-[30svh] items-center justify-center px-6 pb-8 pt-6 sm:px-10 lg:absolute lg:inset-y-0 lg:right-0 lg:flex lg:w-[58%] lg:items-center lg:justify-center lg:px-12 lg:pb-10 lg:pt-6">
          ...
          >
            {slides.map((s, i) => (
              <div key={s.id} className="kc-promo-slide absolute inset-0">
                <Image
                  src={s.image}
                  alt=""
                  fill
